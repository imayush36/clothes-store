...
export const COUPONS = [
  { code: 'TSS200', discountType: 'flat', discountValue: 200, minOrder: 999, description: 'Flat ₹200 OFF on orders above ₹999' },
  { code: 'VIP20', discountType: 'percent', discountValue: 0.20, minOrder: 0, description: '20% OFF for VIP Club Members' },
  { code: 'AURA2026', discountType: 'percent', discountValue: 0.15, minOrder: 0, description: '15% Streetwear Drop Special' }
];
